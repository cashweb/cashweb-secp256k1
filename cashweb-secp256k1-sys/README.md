...
- when a Rust project has two different versions of cashweb-secp256k1 in its
  depepdency tree, or
- when cashweb-secp256k1 is used for building a static library in a context where
